        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>NAMA
                        LENGKAP</strong></td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>NUPL</strong>
                </td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>NO KK</strong>
                </td>
                ...
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
                    <strong>LULUSAN</strong></td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>TMT</strong>
                </td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>STATUS
                        NIKAH</strong></td>
                ...
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
                    <strong>KABUPATEN</strong></td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
                    <strong>KECAMATAN</strong></td>
                <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;"><strong>DESA</strong>
                </td>
            ...
            @foreach($pegawai as $item)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000000;">
                        {{ $item->village ? $item->village->district->regency->province->name :'' }}
                    </td>
                    <td style="border: 1px solid #000000;">
                        {{ $item->village ? $item->village->district->regency->name :'' }}
                    </td>
                    <td style="border: 1px solid #000000;">
                        {{ $item->village ? $item->village->district->name :'' }}
                    </td>
                    <td style="border: 1px solid #000000;">
                        {{ $item->village ? $item->village->name :'' }}</td>
