<div class="content">
    @slot('title')
        <h1 class="font-weight-bold"><i class="mr-3 fas fa-money-bill text-success"></i>Beasiswa {{$student_nama}}</h1>
    @endslot
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <x-th-sort label="Bulan" name="bulan" sortColumn="{{ $sortColumn }}"
                                        sortDirection="{{ $sortDirection }}"></x-th-sort>
                                    <x-th-sort label="Tanggal_terima" name="tanggal_terima" sortColumn="{{ $sortColumn }}"
                                        sortDirection="{{ $sortDirection }}"></x-th-sort>
